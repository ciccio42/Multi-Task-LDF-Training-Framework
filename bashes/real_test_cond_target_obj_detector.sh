...
PROJECT_NAME=Real-1Task-Pick-Place-Cond-Target-Obj-Detector-2 #1Task-Pick-Place-Cond-Target-Obj-Detector-separate-demo-agent #
NUM_WORKERS=1
GPU_ID=2
