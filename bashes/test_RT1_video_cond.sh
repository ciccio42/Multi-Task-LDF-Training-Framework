...
if [ "$TASK_NAME" == 'pick_place' ]; then
    ...
    for MODEL in ${MODEL_PATH}; do
        for S in 60933; do #81000 89100 16035; do #83382(th epoch) #86589(th epoch) #48105(15 epoch) #60933(19th epoch) #96210(30th epoch) #121866 (38 epoch) #150729 (47 epoch) #169971 (53 epoch) #227697 (71 epoch) #246939 (77 epoch) #288630 (90 epoch)
