...
PROJECT_NAME=1Task-Nut-Assembly-Pick-Place-100-180-PREDICTED-BB-2
NUM_WORKERS=5
MODEL_PATH=/user/frosa/multi_task_lfd/checkpoint_save_folder/1Task-Nut-Assembly-Pick-Place-100-180-PREDICTED-BB-2-Batch50/
CONTROLLER_PATH=$BASE_PATH/repo/Multi-Task-LFD-Training-Framework/tasks/multi_task_robosuite_env/controllers/config/osc_pose.json
SAVE_PATH=/user/frosa/multi_task_lfd/checkpoint_save_folder/1Task-Nut-Assembly-Pick-Place-100-180-PREDICTED-BB-2-Batch50/result_pick_place
