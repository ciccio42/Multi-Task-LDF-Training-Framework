...
for MODEL in ${MODEL_PATH}; do
    for S in 262988; do #81000 89100; do
...
# BASE_PATH=/raid/home/frosa_Loc/Multi-Task-LFD-Framework
# PROJECT_NAME=1Task-Nut-Assembly-100-180-All-Obj-One-Task-Left
# NUM_WORKERS=7
# MODEL_PATH=/user/frosa/multi_task_lfd/checkpoint_save_folder/1Task-Nut-Assembly-100-180-All-Obj-One-Task-Left-Batch12
# CONTROLLER_PATH=$BASE_PATH/repo/Multi-Task-LFD-Training-Framework/tasks/multi_task_robosuite_env/controllers/config/osc_pose.json
