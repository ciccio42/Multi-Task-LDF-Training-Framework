...
NUM_WORKERS=10
GPU_ID=1
MODEL_PATH=/user/frosa/multi_task_lfd/checkpoint_save_folder/1Task-Pick-Place-100-180-All-Obj-One-Task-Left-Batch28/
CONTROLLER_PATH=$BASE_PATH/repo/Multi-Task-LFD-Training-Framework/tasks/multi_task_robosuite_env/controllers/config/osc_pose.json

for MODEL in ${MODEL_PATH}; do
    for S in 287100 283910 277530; do #81000 89100; do
        for TASK in pick_place; do
            echo Task ${TASK};
            for COUNT in 1; do    
                if [ $COUNT -eq 1 ]; then
