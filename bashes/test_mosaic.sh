...
for MODEL in ${MODEL_PATH}; do
    for COUNT in 1 2 3; do
        for S in 262988 253814; do #81000 89100; do
            for TASK in nut_assembly pick_place; do
                SAVE_PATH=/user/frosa/multi_task_lfd/checkpoint_save_folder/2Task-Nut-Assembly-Pick-Place-100-180-Batch50/results_${TASK}/run_${COUNT}
