...
NUM_WORKERS=7
GPU_ID=2
MODEL_PATH=/user/frosa/multi_task_lfd/checkpoint_save_folder/${PROJECT_NAME}-Batch27
        ...
        for TASK in nut_assembly; do
            for COUNT in 1; do    
                if [ $COUNT -eq 1 ]; then
                    ...
                    #--wandb_log --gt_bb --save_path ${SAVE_PATH} --save_files
                else
                    SAVE_PATH=${MODEL_PATH}/results_${TASK}/run_${COUNT}
...
# BASE_PATH=/raid/home/frosa_Loc/Multi-Task-LFD-Framework
# PROJECT_NAME=1Task-Button-MOSAIC-Cond-Target-Obj-Detector   
# NUM_WORKERS=7
# GPU_ID=2
# MODEL_PATH=/user/frosa/multi_task_lfd/checkpoint_save_folder/${PROJECT_NAME}-Batch30/
# CONTROLLER_PATH=$BASE_PATH/repo/Multi-Task-LFD-Training-Framework/tasks/multi_task_robosuite_env/controllers/config/osc_pose.json
# for MODEL in ${MODEL_PATH}; do
#     for S in 48954; do #81000 89100; do
...
# BASE_PATH=/raid/home/frosa_Loc/Multi-Task-LFD-Framework
# PROJECT_NAME=1Task-Stack-Block-MOSAIC-GT-BB-ALL-OBJ-One-Variation-Left
# NUM_WORKERS=7
# GPU_ID=1
# MODEL_PATH=/user/frosa/multi_task_lfd/checkpoint_save_folder/${PROJECT_NAME}-Batch25/
# CONTROLLER_PATH=$BASE_PATH/repo/Multi-Task-LFD-Training-Framework/tasks/multi_task_robosuite_env/controllers/config/osc_pose.json
# for MODEL in ${MODEL_PATH}; do
#     for S in 96475; do #81000 89100; do
